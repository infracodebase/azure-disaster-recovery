...
.EXAMPLE
.\Save-NetworkingConfig.ps1 -ResourceGroupName "webapp-prod-primary-rg" -SecondaryResourceGroupName "webapp-prod-secondary-rg" -ProjectName "webapp" -Environment "prod" -StorageAccountName "asrnetworkconfigs" -StorageResourceGroupName "shared-services-rg" -IncludeAppGateway -IncludeLoadBalancer
